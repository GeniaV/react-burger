      ...
      <div className={styles.wrapper}>
        <nav>
          <ul className={`mb-20 ${styles.list}`}>
            <NavLink exact to="/react-burger/profile" className={`text text_type_main-medium ${styles.link}`} activeClassName={styles.activeLink}>
              Профиль
            </NavLink>
            <NavLink exact to="/react-burger/profile/orders" className={`text text_type_main-medium ${styles.link}`} activeClassName={styles.activeLink}>
              История заказов
            </NavLink>
        ...
        <Switch>
          <Route exact path="/react-burger/profile/orders">
            <OrdersPage />
          </Route>
